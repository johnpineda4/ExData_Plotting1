...
# Target Plot is https://github.com/johnpineda4/ExData_Plotting1/blob/master/figure/unnamed-chunk-4.png.
...
legend("topright", pch=NA_integer_, lty="solid", col = c("black","red","blue"), legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), adj=0.4, x.intersp = 6,y.intersp = 1.5)
